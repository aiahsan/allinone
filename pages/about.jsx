...
export default function Index() {
  ...
  return (
    <>
      ...
      <div className="container ab-boxone">
      <h1>Imprint</h1>
      <p>ALLINONE INVESTMENT IN TOURIST AND MANAGEMENT L.L.C</p>
      <p>Dubai</p>
      <p>Port Saeed</p>
      <p>Building PR1005, Office M05-0198</p>
      <p>P.O.Box 449620</p>
      <p>License No 983004</p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to ALLINONE
              INVESTMENT IN TOURIST AND MANAGEMENT L.L.C, Dubai,Port Saeed,
              Building PR1005, Office M05-0198.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to AllinOneCity, accessible from{" "}
              <a
                href="https://allinonecity.com/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://allinonecity.com/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            By mail: ALLINONE INVESTMENT IN TOURIST AND MANAGEMENT L.L.C
            Dubai,Port Saeed, Building PR1005, Office M05-0198, P.O.Box 449620
          </li>
        </ul>
      </div>
            ...
            <Form onKeyDown={onKeyDown}>
              <section className="container subscribe">
                ...
                <div className="flex-between flex-column">
                  <h1 className="fw600 fs33 lh54">{t("e1")}</h1>
